    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asl', models.CharField(blank=True, db_column='ASL', max_length=75, null=True)),
                ...
                ('data_creazione', models.DateTimeField(auto_now_add=True, db_column='Data_creazione', null=True)),
        ...
        migrations.CreateModel(
            name='CapoArea',
            fields=[
                ('id_capo', models.AutoField(db_column='ID_Capo', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codicecontratto', models.CharField(blank=True, db_column='CodiceContratto', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_contratto', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('codice_contratto', models.CharField(blank=True, max_length=2, null=True)),
                ('data_creazione', models.DateTimeField(blank=True, null=True)),
                ('data_modifica', models.DateTimeField(blank=True, null=True)),
                ('note', models.TextField(blank=True, db_column='Note', null=True)),
            ],
        ...
        migrations.CreateModel(
            name='ListaSocieta',
            fields=[
                ('id_societa', models.OneToOneField(db_column='ID_Societa', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='gestione.societa')),
