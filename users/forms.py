...
class AddTrasferteFormRichiesta(forms.ModelForm):
    class Meta:
        model = AddTrasferte
        exclude = ["id_trasferte","id_dip","id_ced","ore","stato","valore","timestamp"]
...
class AddStraordinarioForm(forms.ModelForm):
    class Meta:
        model = AddStraordinari
        exclude = ["id_straordinari","id_dip","id_ced","ore","valore","stato","timestamp"]
